...
We keep this out of the main grid. A population where retrieval failed cannot test a claim about systems at matched retrieval quality. It does bound Section~\ref{sec:verdict}: the ordering of these three evaluators held in every cell we measured on Wikipedia data, and it does not hold here.
